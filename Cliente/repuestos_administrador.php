   ...
   <div class="modal-content">
     ...
     <div class="modal-body">
       <form action="../../Servidor/actualizar_repuesto.php" method="POST">
        ...
        <div class="mb-1">
           <label for="dato" class="col-form-label">Que desea actualizar?:</label>
           <input type="text" class="form-control-sm" id="dato" name="dato">
         </div>


         <div class="mb-1">
           <label for="id">Id del Cambio:</label>
         ...
         <div class="mb-1">
           <label for="dato_nuevo" class="col-form-label">Nuevo dato</label>
