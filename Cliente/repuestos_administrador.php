   ...
   <div class="modal-content">
     ...
     <div class="modal-body">
       <form>
          ...
          <div class="mb-1">
            <form action="repuestos_administrador.php">
           ...
           <!-- <option value="imagen">Imagen</option> -->
            ...
            <input type="button" value="obtener"  id="obtener" name="obtener" class="btn btn-warning">
            </form>
         </div>
        <!-- TOMAR EL DATO DEL SELECT Y ESE DATO LO ENVIO A UNA CASILLA Y  GUARDO EN PHP Y ES EL QUE ACTUALIZO-->

        <?php //DESEO OBTENER EL DATO DEL SELECT
                
               //if (isset['select']) {
                //  $dato = $_REQUEST['select'];
               // }
         ...
         <div class="mb-1">
           <label for="id_busqueda">Id del Cambio:</label>
         ...
         <div class="mb-1">
           <label for="recipient-name" class="col-form-label">Nuevo dato entero:</label>
           <input type="text" class="form-control-sm" id="recipient-name">
         </div>

         <div class="mb-1">
           <label for="consulta" class="col-form-label">Seleccionado:</label>
           <input type="text" class="consulta" id="consulta" name="consulta" disabled placeholder="id">
           <?php
           ?>
         </div>
